...
const { expectParse, expectFailParse } = preamble;

describe("supports states", function() {
  it("recognizes state statements", function() {
    expectParse("AState");
    expectParse("AState1");
    expectParse("ASTATE");
  ...
  it("reject invalid stateish statements", function() {
...
`
  ...
  it("catches double state definitions", function() {
    expectFailParse(`\
SomeState
...
`
  ...
  it("validates state transitions inside blocks", function() {
...
`
  ...
  it("recognizes various state transition statements", () => preamble.runSkill('state-transitions'));

  it("traces state transitions", () => preamble.runSkill('state-tracing'));
});
